        ...
        <aside>
            <ul id="editTools" :style="toolbarStyle">
                <li v-for="tool in visibleEditTools" v-if="tool.show">
                    ...
                    <i class="fas" :class="tool.icon" @click="useTool(tool)"></i>
                </li>
            </ul>
        </aside>

        <article>
            <v-block v-for="(block, index) in blocks" :item="block" :editing="blockIsEditing(index)" :key="index" @click="selectBlock(index)" :class="{selected: index == selectedIndex}"></v-block>
...
<script type="text/x-template" id="v-block-template">
    <component :is="blocktype" :item="this.item" :editing="this.editing" class="v-block" :class="{editing: this.editing}" @click="onClick" @input="onInput" />
</script>

<script type="text/x-template" id="v-quote-template">
    <blockquote @click="onClick">
        <v-text :item="{type: 'header', content: this.item.content}" :editing="this.editing" @input="onInput" />
        <v-text :item="{type: 'footer', content: this.item.footer}" :editing="this.editing" @input="onInputFooter" />
    </blockquote>
</script>

<script type="text/x-template" id="v-image-template">
